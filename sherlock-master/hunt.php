  ...
  <?php
    ...
    else if($finished==0)
    {
      ...
      <?php
         ...
         ?>
                   <div class="container whitecolor question my-4" style="font-weight:600;font-size:40px;text-shadow:0px 0px 5px #000000;">Next Qusetion Will be Available On:<?php echo $tym; ?>  Please wait...... 
              <?php 
            }
    }
    else
